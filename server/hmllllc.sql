...
INSERT INTO article VALUES(5005,'风间',005,'不知儿时的你@是否背着锅跟着老师去野炊过@在露着石床的小溪边@一弯清水倒映着青山@一本正经的炒完所带的各类菜品@依山傍水别提吃的多开心@纵然几十年过去了记忆犹新@（此处暴露了年龄）@小桥流水、亭台楼阁、@绿树成荫的用餐环境@就是惠众森林餐厅最初的情怀','5005art_img001.jpg-5005art_img002.jpg-5005art_img003.jpg-5005art_img004.jpg','上海',434,9005);
...
CREATE TABLE `carousel` (
 ...
 INSERT INTO carousel VALUES(8001,"8001car_img01.jpg","8001car_img02.jpg","8001car_img03.jpg","8001car_img04.jpg","index");
